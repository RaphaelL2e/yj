...
public class ServerResponse<T> implements Serializable {
    ...
    public static <T> ServerResponse<T> createBySuccess() {
        return new ServerResponse<T>(ResponseCode.SUCCESS.getCode(), "操作成功");
    }
    ...
    public static <T> ServerResponse<T> createByErrorCodeMessage(ErrorCodeEnum errorCodeEnum) {
        return new ServerResponse<T>(errorCodeEnum.getCode(), (T) errorCodeEnum.getMsg());
    }
